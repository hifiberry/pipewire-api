...
.PHONY: all api clean install install-all install-api install-api-man install-config deb deb-clean
...
install: install-api-man install-config install-api

install-all: install-api-man install-config install-api
